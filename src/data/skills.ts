export const skills = [
  {
    ...
    description: "Some discription long enough to wrap to multiple lines for testing purposes. And showing how it looks.",
  },
  {
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M8 17l-5-5 5-5v3l-2 2 2 2v3zm8-10l5 5-5 5v-3l2-2-2-2V7z"/></svg>`,
    title: "The Principles and Practice Workshops",
    description: "Some discription long enough to wrap to multiple lines for testing purposes. And showing how it looks.",
  },
  {
    ...
    title: "Research Strategy and Experimental Design",
    description: "Some discription long enough to wrap to multiple lines for testing purposes. And showing how it looks.",
  },
  {
    ...
    title: "Bioinformatics and Analytics Support",
    description: "Some discription long enough to wrap to multiple lines for testing purposes. And showing how it looks.",
  },
  {
  ...
  },
  {
    ...
    {
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 18H6a4 4 0 010-8 5 5 0 019.9-1.5A4.5 4.5 0 1119 18z"/></svg>`,
    title: "Center Membership – Benefits, Responsibilities, and Process",
    description: "Some discription long enough to wrap to multiple lines for testing purposes. And showing how it looks.",
  },
];
